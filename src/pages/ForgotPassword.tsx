  ...
  return (
    ...
    >
      <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 md:p-12">
        <h1 className="text-3xl font-serif italic mb-8">Reset Password</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-[10px] uppercase tracking-widest text-white/40 mb-2">New Password</label>
            <input 
              type="password" 
              value={newPassword}
        ...
        <p className="mt-8 text-center text-[10px] text-white/40 uppercase tracking-widest">
          Remembered your password? <Link to="/login" className="text-brand hover:underline">Access Archive</Link>
        </p>
      </div>
    </motion.div>
  );
